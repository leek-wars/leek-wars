	...
	if (LeekWars.legacyTheme) {
		...
		monaco.editor.defineTheme("leek-wars", {
			...
			rules: [
				...
				{ token: "lsfunction-deprecated", foreground: '6e7b69', fontStyle: 'italic strikethrough' },
...
export function defineLeekWarsThemes(monaco: typeof Monaco) {
	...
	monaco.editor.defineTheme("leek-wars-dark", {
		...
		rules: [
			...
			{ token: "lsfunction-deprecated", foreground: '6b7a66', fontStyle: 'italic strikethrough' },
