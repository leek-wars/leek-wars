	...
	const VOCABULARY = [
		{
			...
			entries: [
				...
				{ concept: 'Éleveur', icon: 'mdi-account', note: "La silhouette pleine. Un éleveur PRÉCIS garde son avatar. Ni mdi-account-group (groupes privés) ni mdi-account-multiple (une liste de gens)." },
				{ concept: 'Niveau', icon: 'mdi-stairs', note: "Les marches — un niveau est un palier. Ni mdi-transfer-up (la MONTÉE de niveau) ni mdi-chevron-triple-up (la pastille de rang)." },
		...
		},
		{
			...
			entries: [
				...
				{ concept: 'Puce', icon: 'mdi-chip', note: "Panneau et dialogue de puces de la page poireau, onglet du groupe, dialogue de montée de niveau." },
				{ concept: 'Invocation', icon: 'mdi-flower', note: "Les invocations poussent : bulbe, maïs, piment, prototaxite. mdi-sprout est pris (widget Poireaux) et mdi-seed dit la GRAINE d'un combat." },
				{ concept: 'Coffre', icon: 'mdi-treasure-chest', note: "Le coffre du jeu, et l'Inventaire, qui EST un coffre : même objet, même dessin." },
				{ concept: 'Tourelle', icon: 'mdi-tower-fire', note: "Déjà la bascule des tourelles du graphique de vie du rapport." },
