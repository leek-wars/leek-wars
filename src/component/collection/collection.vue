<template>
	<div class="page">
		<div class="page-header page-bar">
			...
			<div class="tabs">
				<router-link v-if="env.BANK && $store.state.farmer?.bank_enabled" to="/bank?ref=collection_tab">
				...
				<div class="tab action active" icon="mdi-trophy-variant-outline" link="/collection">
