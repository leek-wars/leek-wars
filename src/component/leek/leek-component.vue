<template lang="html">
	<rich-tooltip-item v-if="component" v-slot="{ on }" :item="LeekWars.items[component.template]" :bottom="true">
		<div class="component" :class="{dragging: $parent.draggedComponent && $parent.draggedComponent.template === component.template && $parent.draggedComponentLocation === 'leek'}" draggable="true" v-on="on" @dragstart="$emit('componentDragStart', 'leek', component, $event)" @dragend="$emit('componentDragEnd', component)">
