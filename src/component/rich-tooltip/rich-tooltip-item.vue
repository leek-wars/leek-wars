<template>
	<v-menu v-model="value" :close-on-content-click="false" :min-width="280" offset-overflow :nudge-top="bottom ? 0 : 6" :open-delay="_open_delay" :close-delay="_close_delay" :top="!bottom" :bottom="bottom" transition="none" :open-on-hover="!locked" offset-y :nudge-right="nodge ? 20 : 0" @input="$emit('input', $event)">
