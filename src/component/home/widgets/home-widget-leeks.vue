<template>
	<div class="leeks-widget">
		<router-link v-for="leek in leeks" :key="leek.id" v-ripple :to="'/leek/' + leek.id" class="leek card">
		...
		<router-link v-if="canCreate" v-ripple to="/new-leek" class="leek card new">
