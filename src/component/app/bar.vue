	...
	<div id="app-bar" :class="{subtitle: LeekWars.subtitle}">
		...
		<div class="actions-wrapper">
			<div class="static-actions">
				<div v-show="LeekWars.menuExpanded || $store.state.unreadMessages > 0" class="action header-button mobile messages-button">
				...
				<div v-show="LeekWars.menuExpanded || $store.state.unreadNotifications > 0" class="action header-button mobile notifications-button">
