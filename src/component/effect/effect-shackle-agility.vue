...
<template>
	<i18n-t keypath="fight.leek_loose_x_turns" tag="div" :a="props.a">
		<leek slot="leek" :leek="props.leek" />
		<template v-slot:value>
			<b class="color-agility">{{ parent.$t('fight.n_agility', [props.value]) }}</b>
		</template>
...
<script lang="ts">
	...
	export default class EffectShackleAgility extends Vue {
		@Prop() leek!: FightLeek
		@Prop() value!: number
		@Prop() turns!: number
		@Prop() a!: number
