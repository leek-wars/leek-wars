...
<template>
	<i18n-t keypath="fight.leek_loose_x_turns" tag="div" :a="a">
		<leek slot="leek" :leek="leek" />
		<template v-slot:value>
			<b class="color-strength">{{ $t('fight.n_strength', [value]) }}</b>
		</template>
...
<script lang="ts">
	...
	export default class EffectShackleStrength extends Vue {
		@Prop() leek!: FightLeek
		@Prop() value!: number
		@Prop() turns!: number
		@Prop() a!: number
