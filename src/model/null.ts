...
export const COMPONENTS: {[key: string]: ComponentTemplate} = Object.freeze({
  '1': { id: 1, name: 'core', stats: [ [ 'cores', 1 ] ], template: 290 },
  '2': { id: 2, name: 'core2', stats: [ [ 'frequency', 20 ], [ 'cores', 4 ] ], template: 291 },
  '3': { id: 3, name: 'core3', stats: [ [ 'frequency', 30 ], [ 'cores', 8 ], [ 'tp', 1 ] ], template: 292 },
  ...
  '6': { id: 6, name: 'amazonite_plate', stats: [ [ 'life', 100 ], [ 'resistance', 60 ] ], template: 295 },
  '7': { id: 7, name: 'obsidian_plate', stats: [ [ 'life', 200 ], [ 'resistance', 80 ] ], template: 296 },
  '8': { id: 8, name: 'spring', stats: [ [ 'strength', 20 ], [ 'agility', 50 ] ], template: 297 },
  '9': { id: 9, name: 'copper_spring', stats: [ [ 'strength', 40 ], [ 'agility', 90 ] ], template: 298 },
  '10': { id: 10, name: 'elinvar_spring', stats: [ [ 'life', 100 ], [ 'agility', 80 ], [ 'strength', 30 ], [ 'resistance', 20 ] ], template: 299 },
  '11': { id: 11, name: 'ssd', stats: [ [ 'wisdom', 80 ], [ 'science', 30 ], [ 'ram', 2 ] ], template: 300 },
  '12': { id: 12, name: 'nuclear_core', stats: [ [ 'life', -200 ], [ 'science', 80 ], [ 'frequency', 60 ], [ 'tp', 3 ] ], template: 301 },
  '13': { id: 13, name: 'fan', stats: [ [ 'frequency', 40 ] ], template: 302 },
  '14': { id: 14, name: 'sdcard', stats: [ [ 'wisdom', 60 ] ], template: 303 },
  ...
  '17': { id: 17, name: 'neural_core_pro', stats: [ [ 'science', 80 ], [ 'frequency', 50 ], [ 'cores', 4 ], [ 'tp', 1 ] ], template: 306 },
  '18': { id: 18, name: 'power_supply', stats: [ [ 'frequency', 40 ], [ 'science', 10 ], [ 'tp', 2 ] ], template: 307 },
  '19': { id: 19, name: 'chiyembekezo', stats: [ [ 'life', 100 ], [ 'agility', 30 ], [ 'magic', 80 ], [ 'tp', 1 ] ], template: 308 },
  '20': { id: 20, name: 'uzoma', stats: [ [ 'life', 200 ], [ 'agility', 40 ], [ 'magic', 60 ], [ 'tp', 2 ] ], template: 309 },
  ...
  '24': { id: 24, name: 'ram', stats: [ [ 'ram', 2 ] ], template: 313 },
  '25': { id: 25, name: 'ram2', stats: [ [ 'life', 40 ], [ 'ram', 4 ], [ 'science', 20 ] ], template: 314 },
  '26': { id: 26, name: 'ram3', stats: [ [ 'life', 80 ], [ 'ram', 8 ], [ 'tp', 1 ] ], template: 315 },
  '27': { id: 27, name: 'motherboard', stats: [ [ 'science', 40 ], [ 'frequency', 10 ], [ 'cores', 1 ], [ 'ram', 1 ] ], template: 316 },
  ...
  '31': { id: 31, name: 'hylocereus', stats: [ [ 'life', 400 ], [ 'wisdom', 40 ], [ 'magic', 40 ], [ 'tp', 1 ] ], template: 320 },
  ...
  '38': { id: 38, name: 'blue_plum', stats: [ [ 'life', 90 ], [ 'science', 50 ], [ 'agility', 50 ], [ 'mp', 1 ] ], template: 369 },
  '39': { id: 39, name: 'kiwi', stats: [ [ 'wisdom', 20 ], [ 'tp', -1 ], [ 'mp', 1 ] ], template: 370 },
  '40': { id: 40, name: 'quince', stats: [ [ 'life', 80 ], [ 'resistance', 40 ], [ 'tp', 1 ] ], template: 371 },
  ...
  '43': { id: 43, name: 'soursop', stats: [ [ 'strength', 50 ], [ 'frequency', 30 ], [ 'mp', 1 ] ], template: 374 },
  ...
  '46': { id: 46, name: 'motherboard2', stats: [ [ 'science', 60 ], [ 'frequency', 20 ], [ 'cores', 2 ], [ 'ram', 2 ], [ 'tp', 1 ] ], template: 381 },
  '47': { id: 47, name: 'motherboard3', stats: [ [ 'wisdom', 40 ], [ 'science', 80 ], [ 'frequency', 30 ], [ 'cores', 3 ], [ 'ram', 3 ], [ 'tp', 2 ] ], template: 382 },
