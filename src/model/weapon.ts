...
const WeaponsData = {
	...
	// Sabre du désert
	41: { width: 230, height: 54, centerX: 36, centerZ: 28, x: -40, z: -15, hand1x: 26, hand1z: 24, hand2x: 44, hand2z: 24, top: 0, bottom: 14, right: 110, white: true },
	// Lance du soleil
	42: { width: 440, height: 73, centerX: 51, centerZ: 30, x: -77, z: -36, hand1x: 56, hand1z: 36, hand2x: 119, hand2z: 36, top: 0, bottom: 39, right: 143, white: true },
