...
// nue, et un corps vide (502, timeout Traefik) arrive ici en `null` — un corps illisible, lui,
// est enveloppé par `request()` dans `{invalid_response}`. Sans normalisation les appelants
// lisent `error.error === undefined` puis appellent `t(undefined)`,
