...
const LeekWars = {
	...
	DEV,
	LOCAL,
	API: LOCAL ? window.location.origin + '/api/' : 'https://' + window.location.host + '/api/',
	SERVER: LOCAL ? window.location.origin + '/' : 'https://' + window.location.host + '/',
	AVATAR: DEV ? 'https://' + window.location.host + '/' : 'https://' + window.location.host + '/',
	STATIC: '/',
	POWER_FACTOR: 4.2,
	post,
	get,
