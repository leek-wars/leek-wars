...
export const COMPONENTS: {[key: string]: ComponentTemplate} = Object.freeze({
  ...
  '19': { id: 19, name: 'chiyembekezo', stats: [ [ 'life', 200 ], [ 'agility', 30 ], [ 'magic', 80 ], [ 'tp', 2 ] ], template: 308 },
  '20': { id: 20, name: 'uzoma', stats: [ [ 'life', 100 ], [ 'agility', 40 ], [ 'magic', 60 ], [ 'tp', 1 ] ], template: 309 },
  ...
  '47': { id: 47, name: 'motherboard3', stats: [ [ 'wisdom', 40 ], [ 'science', 80 ], [ 'frequency', 30 ], [ 'cores', 4 ], [ 'ram', 4 ], [ 'tp', 2 ] ], template: 382 },
