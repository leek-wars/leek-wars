...
const TROPHY_CATEGORIES = [ { id: 1, name: 'general' }, { id: 2, name: 'fight' }, { id: 3, name: 'tournament' }, { id: 7, name: 'code' }, { id: 4, name: 'fun' }, { id: 10, name: 'arena' }, { id: 9, name: 'boss' }, { id: 8, name: 'shopping' }, { id: 5, name: 'social' }, { id: 6, name: 'bonus' } ]
