...
const router = new Router({
	...
	routes: [
		...
		{ path: '/forgot-password', component: ForgotPassword, beforeEnter: connected },
		{ path: '/forgot-password/email-sent/:email', component: ForgotPassword, props: {state: 'email_sent'}, beforeEnter: connected },
		{ path: '/forgot-password/:id/:code', component: ForgotPassword, props: {state: 'change_password'}, beforeEnter: connected },
		...
		{ path: '/moderation', component: Moderation, beforeEnter: connected },
		{ path: '/moderation/fault/:id', component: Moderation, beforeEnter: connected },
		...
		{ path: '/search/:query', component: Search, beforeEnter: connected },
		{ path: '/search/:query/page-:page', component: Search, beforeEnter: connected },
		{ path: '/search/:query/:farmer', component: Search, beforeEnter: connected },
		{ path: '/search/:query/:farmer/page-:page', component: Search, beforeEnter: connected },
		{ path: '/search/:query/:farmer/:category', component: Search, beforeEnter: connected },
		{ path: '/search/:query/:farmer/:category/page-:page', component: Search, beforeEnter: connected },
