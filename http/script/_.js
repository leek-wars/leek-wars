...
_.lang.load = function(file, private_file, callback) {
	...
	if (private_file) {
		...
		$.get(LW.staticURL + 'lang/' + _.lang.current + '/' + file + '.lang' + (_.local ? '' : ('?' + _.version)), function(data) {
